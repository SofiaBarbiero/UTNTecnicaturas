...
namespace UTNtecnicaturas.Presentacion.Report3 {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            private global::System.Data.DataColumn columnEstudiantes;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn EstudiantesColumn {
                get {
                    return this.columnEstudiantes;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DataTable1Row AddDataTable1Row(string Estudiantes, string Email, string Telefono, string Direccion, int DNI, System.DateTime FechaNacimiento, decimal Promedio, string EstadoLaboral, string EstadoAcademico) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DataTable1Row FindByLegajo(int Legajo) {
            ...
            internal void InitVars() {
                ...
                this.columnEstudiantes = base.Columns["Estudiantes"];
            ...
            private void InitClass() {
                ...
                this.columnEstudiantes = new global::System.Data.DataColumn("Estudiantes", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnEstudiantes);
                ...
                this.columnEstudiantes.ReadOnly = true;
                this.columnEstudiantes.MaxLength = 101;
                ...
                this.columnEstadoAcademico.AllowDBNull = false;
                this.columnEstadoAcademico.MaxLength = 50;
            }
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public string Estudiantes {
                get {
                    try {
                        return ((string)(this[this.tableDataTable1.EstudiantesColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Estudiantes\' de la tabla \'DataTable1\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableDataTable1.EstudiantesColumn] = value;
                }
            }
            ...
            public string EstadoLaboral {
                get {
                    return ((string)(this[this.tableDataTable1.EstadoLaboralColumn]));
                }
                set {
                    this[this.tableDataTable1.EstadoLaboralColumn] = value;
                }
            }
            ...
            public string EstadoAcademico {
                get {
                    return ((string)(this[this.tableDataTable1.EstadoAcademicoColumn]));
                }
                set {
                    this[this.tableDataTable1.EstadoAcademicoColumn] = value;
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsEstudiantesNull() {
                return this.IsNull(this.tableDataTable1.EstudiantesColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetEstudiantesNull() {
                this[this.tableDataTable1.EstudiantesColumn] = global::System.Convert.DBNull;
            }
...
namespace UTNtecnicaturas.Presentacion.Report3.DataSet3TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("EstadoAcademico", "EstadoAcademico");
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        e.legajo_est AS \'Legajo\', e.nom_est + SPACE(1) + e.ape_est AS \'Estu" +
                "diantes\', e.email AS \'Email\', e.telefono AS \'Telefono\', e.calle + \'Nro \' + trim(" +
                "STR(e.nro_calle)) + \' Barrio \' + b.barrio AS \'Direccion\', e.nro_documento AS \'DN" +
                "I\', \r\n                         e.fecha_nac AS \'FechaNacimiento\', AVG(exm.calific" +
                "acion) AS \'Promedio\', lab.estado_lab AS \'EstadoLaboral\', esta.estado_academico A" +
                "S \'EstadoAcademico\'\r\nFROM            ESTUDIANTES AS e INNER JOIN\r\n              " +
                "           ESTUDIANTES_MATERIAS AS em ON e.legajo_est = em.legajo_est INNER JOIN" +
                "\r\n                         MATERIAS AS m ON m.id_materia = em.id_materia INNER J" +
                "OIN\r\n                         ESTADOS_ACADEMICOS AS est ON est.id_estado_acad = " +
                "em.id_estado_acad INNER JOIN\r\n                         EXAMEN_MATERIAS AS exm ON" +
                " exm.id_materia = m.id_materia INNER JOIN\r\n                         CURSOS AS c " +
                "ON c.id_curso = em.id_curso INNER JOIN\r\n                         CUATRIMESTRES A" +
                "S cuatri ON cuatri.id_cuatrimestre = em.id_cuatrimestre INNER JOIN\r\n            " +
                "             ESTADOS_ACADEMICOS AS esta ON esta.id_estado_acad = em.id_estado_ac" +
                "ad INNER JOIN\r\n                         ESTADOS_LABORALES AS lab ON lab.id_estad" +
                "o_lab = e.id_estado_lab INNER JOIN\r\n                         BARRIOS AS b ON b.i" +
                "d_barrio = e.id_barrio INNER JOIN\r\n                         TECNICATURAS_MATERIA" +
                "S AS tec ON tec.id_materia = m.id_materia\r\nWHERE        (tec.id_tecnicatura = 1)" +
                " AND (e.condicion = 1) AND (em.id_estado_acad = 1) AND (e.id_estado_lab IN (1, 2" +
                ", 3, 5)) AND (em.id_cuatrimestre NOT IN (1, 2, 7))\r\nGROUP BY e.legajo_est, e.nom" +
                "_est + SPACE(1) + e.ape_est, e.email, e.telefono, e.calle + \'Nro \' + trim(STR(e." +
                "nro_calle)) + \' Barrio \' + b.barrio, e.nro_documento, e.fecha_nac, lab.estado_la" +
                "b, esta.estado_academico, e.fecha_ingreso\r\nHAVING        (AVG(exm.calificacion) " +
                ">\r\n                             (SELECT        AVG(calificacion) AS Expr1\r\n     " +
                "                          FROM            EXAMEN_MATERIAS AS exm\r\n              " +
                "                 WHERE        (DATEDIFF(year, e.fecha_ingreso, GETDATE()) = 0) A" +
                "ND (e.legajo_est = legajo_est)))\r\nORDER BY \'Legajo\', \'Estudiantes\'";
